sap.ui.define([
    ...
    return Controller.extend("org.ubb.books.controller.BookList", {
        ...
        handleSave(oEvent) {
            ...
            oDialogData.NumberOfAvailableBooks = oDialogData.NumberOfAvailableBooks;
            oDialogData.TotalNumberOfBooks = oDialogData.TotalNumberOfBooks;
            if(oDialogData.NumberOfAvailableBooks > oDialogData.TotalNumberOfBooks) {
                validForm = false;
                var sMsg = oBundle.getText("noGreater");
                MessageToast.show(sMsg);
            }
            oDialogData.DatePublished = "2015-12-31T00:00:00";
            if(validForm) {
        ...
        onUpdate(oEvent) {
            ...
            if (selectedRows.length === 0) {
                ...
                var book = {
                    ...
                    Title: oObject.Title,
                    DatePublished: oObject.DatePublished,
                    Language: oObject.Language,
                    TotalNumberOfBooks: oObject.TotalNumberOfBooks,
                    NumberOfAvailableBooks: oObject.NumberOfAvailableBooks
                };
